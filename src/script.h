...
#ifndef H_NOMAD_SCRIPT
#define H_NOMAD_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CNomadAddress
 */
...
public:
    ...
    // Pre-version-0.6, Nomad always counted CHECKMULTISIGs
