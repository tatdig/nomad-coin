...
#if defined(NDEBUG)
# error "Nomad cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Nomad Signed Message:\n";
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal nomad miner
