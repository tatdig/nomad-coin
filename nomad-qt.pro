...
contains(NOMAD_NEED_QT_PLUGINS, 1) {
    DEFINES += NOMAD_NEED_QT_PLUGINS
...
HEADERS += src/qt/nomadgui.h \
    ...
    src/qt/nomadaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/chainparams.h \
...
SOURCES += src/qt/nomad.cpp src/qt/nomadgui.cpp \
    ...
    src/qt/nomadaddressvalidator.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/txmempool.cpp \
    ...
    src/qt/nomadstrings.cpp \
    src/qt/nomadamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/nomad.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/nomad_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/nomad-qt.rc
...
windows:RC_FILE = src/qt/res/nomad-qt.rc
...
macx:ICON = src/qt/res/icons/nomad.icns
macx:TARGET = "Nomad-Qt"
